...
?>
    <style>
        ...
        .recommended-mode-section-title {
            display: flex;
            align-items: center;
        }
        .recommended-mode-section-title img {
            width: 80px;
        }
    </style>
    ...
    <div class="triplea_step" id="step-enabled"
        ...
        <div id="step-enabled--btc2btc-sandbox"
            ...
            <h3>
                <span style="text-decoration: underline;">Sandbox</span> Cryptocurrency payments are enabled.
            </h3>
            
            <p>
                <?php printf(_x("You have chosen to receive sandbox cryptocurrency payments straight in your own %s.", 'You have chosen to receive sandbox cryptocurrency payments straight in your own testnet cryptocurrency wallet.', 'triplea-cryptocurrency-payment-gateway-for-woocommerce'), '<strong>'.__('testnet cryptocurrency wallet','triplea-cryptocurrency-payment-gateway-for-woocommerce').'</strong>') ?>


                
            </p>
            <p>
                <?php printf(_x('View transactions in your own wallet or %s with the credentials you have received by email.', 'View transactions in your own wallet or in your TripleA dashboard with the credentials you have received by email.', 'triplea-cryptocurrency-payment-gateway-for-woocommerce'), '<a href="https://dashboard.triple-a.io" target="_blank">'.__('cryptocurrency testnet faucets', 'triplea-cryptocurrency-payment-gateway-for-woocommerce').'.</a>') ?>
            </p>
            <p>
                <?php printf(_x('You can use %s to easily test payments.', 'You can use cryptocurrency testnet faucets to easily test payments', 'triplea-cryptocurrency-payment-gateway-for-woocommerce'), '<a href="https://duckduckgo.com/?q=bitcoin+testnet+faucets" target="_blank">'.__('cryptocurrency testnet faucets', 'triplea-cryptocurrency-payment-gateway-for-woocommerce').'</a>') ?>
            </p>
            <br>
        ...
        <div id="step-enabled--btc2btc"
            ...
            <h3>
                <span style="text-decoration: underline;"><?php printf(_x('Live', 'Live Cryptocurrency payments are enabled.', 'triplea-cryptocurrency-payment-gateway-for-woocommerce')) ?></span> <?php //printf(_x('Live', 'Live Cryptocurrency payments are enabled.', 'triplea-cryptocurrency-payment-gateway-for-woocommerce')) ?>
            </h3>
            <h4>You will receive cryptocurrency in your wallet.</h4>
            <p>
                You have chosen to receive cryptocurrency payments straight in your own <strong>cryptocurrency wallet</strong>.
            </p>
            <hr>
            <p>
                <strong>[Expert Mode]</strong> will no longer be supported. The plugin will focus on multi-crypto payments.<br>
                You can continue to use it, as long as it works. We recommend you switch to tripleA account for more currencies,<br>
                better user experience and easy settlement to bank (requires KYC and KYB).<br>
            </p>
            <span>
                <strong>Switching to a tripleA account means:</strong>
                <ul style="list-style:inherit;padding:0 20px;">
                    <li>Multiple cryptocurrencies available for payment by customers</li>
                    <li>Cryptocurrencies received by TripleA on your behalf, counted in your local currency (USD, EUR, other) of choice</li>
                    <li>We settle to your bank account once a threshold of 1000 USD value is reached with a 0.8% fee (you can contact us to request lower threshold for first months)</li>
                    <li>You can also request to be paid out in cryptocurrency instead of bank settlement, via the TripleA dashboard</li>
                </ul>
            </span>
            <hr>
            <p>
                Cryptocurrency payments you receive can be viewed in your own wallet or for more details,
                <br>
        ...
        <div id="step-enabled--btc2fiat"
            ...
            <h3 style="display:<?php echo($sandbox_payment_mode ? 'block' : 'none') ?>;"><span style="text-decoration: underline;">Sandbox</span> cryptocurrency payments are enabled.</h3>
            
            <h3 style="display:<?php echo(!$sandbox_payment_mode ? 'block' : 'none') ?>;"><span style="text-decoration: underline;">Live</span> cryptocurrency payments are enabled.</h3>
            <h3 style="display:<?php echo(!$sandbox_payment_mode ? 'block' : 'none') ?>;">
                You will receive local currency.
            </h3>

            <p id="btc2fiat-message">
                You have chosen to receive cryptocurrency payments in the form of
    ...
    <div class="triplea_step" id="step-1"
        ...
        <h3 style="display:<?php echo($btc2btc_is_active || $btc2fiat_is_active ? "block" : 'none') ?>;">Change your active cryptocurrency payments account</h3>
        <!-- <p>
            How do you wish to receive cryptocurrency payments?
        </p> -->
        <div class="recommended-mode-section-title">
            <!-- <input type="radio"
                name="receive-choice"
                value="localcurrency"
            <?php //echo($btc2fiat_is_active || $old_btc2fiat_is_active || !$btc2btc_is_active ? "checked" : '') ?>
                style="margin:10px;"> -->
            Receive local currency via bank settlement. Supported cryptocurrencies for payment: &nbsp;<img src="<?php echo TRIPLEA_CRYPTOCURRENCY_PAYMENT_GATEWAY_FOR_WOOCOMMERCE_MAIN_URL_PATH; ?>assets/img/crypto-default-icon.png" alt="Cryptocurrency logo"/><br>
        </div>
        <div class="short-summary">
            The payments that you receive will be visible on your dashboard. TripleA is a licensed entity and complies with the highest<br>
            international standards for AML and KYC/KYB. Terms and conditions apply on settlements and AML. For more information, visit our <a href="https://triple-a.io/plugin-faq/">FAQ</a>.
        </div>
        <div class="receive-choice-wrapper"
           ...
           id="localcurrency-form-wrapper">
            <div style="display:<?php echo(!empty($old_btc2fiat_api_id) && empty($fiat_merchant_key) ? "block" : "none") ?>;" id="fiat-version-upgrade-form-wrapper">
                ...
                <div class="triplea_step"
                    ...
                    <small style="color:darkred;display:none;"
                        ...
                        contact
                        us at plugin.support@triple-a.io so that we can assist you.
                    </small>
                    <p id="fiat-upgrade-enter-otp" style="opacity: 0.5;">
                        ...
                        <small style="color:darkred;display:none;"
                            ...
                            at
                            plugin.support@triple-a.io so that we may assist you promptly.
                        </small>
                    </p>
                </div>
            </div>
            <div class="receive-choice-update-wrapper"
                ...
                <!--<input type="button" class="button-secondary" value="Update my testnet cryptocurrency wallet" onclick="jQuery('#testnetbitcoin-signup-form-wrapper').show()">-->
            </div>
            <div style="display:<?php echo(empty($triplea_btc2fiat_sandbox_api_id) && empty($old_btc2fiat_api_id) ? "block" : "none") ?>;" id="localcurrency-signup-form-wrapper">
                ...
                <div class="triplea_step" id="receive-localcurrency-form">
                    ...
                    <!--<p>
                        Master public key of your Testnet cryptocurrency wallet:
                        ...
                        <input type="text"
                                ...
                                style="width: 330px;">
                        <span>Please provide a valid master public key (starts with 'tpub', 'upub' or 'vpub') for your Testnet cryptocurrency wallet.</span>
                    ...
                    <p>
                        ...
                        <!--<span style="color:darkred;display:none;"
                            ...
                            This master public key has been associated with another email address. <a href="mailto:plugin.support@triple-a.io">Contact us at plugin.support@triple-a.io</a> if you need assistance.-->
                        </span>
                        <br>
                        <small style="color: darkred;display:none;"
                    ...
                    <p>
                        ...
                        <span class="woocommerce-help-tip"
                                data-tip="Choose your preffered currency that you want for settlement."></span>
                        <br>
                        <select name="preferred-currency" 
                        ...
                        <span>This will become your account bank settlement currency which can not be changed later on. You would have to create a new account.</span>
                    </p>
                    <p>
                        <input type="checkbox" name="termsncondition" class="triplea-terms" checked>By clicking the button below, I confirm that I have read &amp; accepted the <a href="https://triple-a.io/privacy-and-terms-policy/" target="_blank">terms and conditions</a>.
                    </p>
                    <input type="button"
                            class="button-primary signup-btn"
                            value="Proceed"
        ...
        <?php if( $btc2btc_is_active ) : ?>
        <h4>Switch to local currency (you will not be able to switch back to using your personal wallet)</h4>
        <?php endif; ?> 
        <div style="display:none;">
            <input type="radio"
                ...
                <?php echo($btc2btc_is_active ? "checked" : '') ?>
                    style="margin:10px;"><strong>Expert Mode</strong> - Receive cryptocurrency <strong>[BTC only & will be deprecated in early 2022]</strong><br>
            <div class="receive-choice-wrapper"
                ...
                <div class="triplea_step" id="upgrade-bitcoin-form">
                    <h3>
                        <small>
                            Upgrade your cryptocurrency account
                        </small>
                    </h3>
                    <p>
                        Due to technical improvements and added features, your account needs to be upgraded (a simple click!).
                ...
                <div class="triplea_step"
                    ...
                    <p id="bitcoin-upgrade-enter-otp" style="opacity: 0.5;">
                        ...
                        <small style="color:darkred;display:none;"
                            ...
                            The provided OTP was correct. However, something went wrong
                            during
                            the creation of your live cryptocurrency account. Please inform us
                            at
                            plugin.support@triple-a.io so that we may assist you promptly.
                        </small>
                    </p>
        ...
        <div class="receive-choice-update-wrapper"
                style="display:none <?php echo(!empty($triplea_btc2btc_api_id) || !empty($triplea_btc2btc_sandbox_api_id) ? "block" : 'none') ?>;"
            ...
            <input type="button" class="button-secondary" value="Update my cryptocurrency wallet" onclick="jQuery('#bitcoin-signup-form-wrapper').show()">
            <br>
        </div>
        <div style="display:none<?php //echo(empty($triplea_btc2btc_api_id) && empty($triplea_btc2btc_sandbox_api_id) && empty($old_btc2btc_api_id) ? "block" : "none") ?>;" id="bitcoin-signup-form-wrapper">
            <hr>
            <div class="triplea_step" id="receive-bitcoin-form">
                <h3>
                    <small>
                        1. Provide cryptocurrency wallet information
                    </small>
                </h3>
                <p>
                    Master public key of your cryptocurrency wallet:
                    <span class="woocommerce-help-tip"
                            data-tip="Your master public key can only be used to generate payment addresses and view balances. We recommend creating a new, empty cryptocurrency wallet for use with this plugin."></span>
                    <br>
                    <input type="text"
                    ...
                    <br>
                    <!-- <span>
                        Please provide a valid master public key for your cryptocurrency wallet (starting with 'xpub', 'ypub' or 'zpub').
                        <br>You can also use a testnet cryptocurrency wallet for sandbox testing (public key starting with 'tpub', 'upub' or 'vpub').
                    ...
                    Ledger wallet and <a href="https://www.blockchain.com" target="_blank">Blockchain.com</a> wallet do not provide the correct public key! Avoid using these wallets. 
                    <br>Please make sure to test with a 1$ payment to verify if your wallet detects the payment. 
                    <br>If your wallet does not detect the payment, it has the same issue as Ledger and <a href="https://www.blockchain.com" target="_blank">Blockchain.com</a> and in that case you better use <a href="https://electrum.org/#home" target="_blank">Electrum.org</a> or Exodus wallets.
                    </span>
                    <span style="color: darkred;display:none;"
                            class="triplea-error-msg"
                ...
                <p>
                    ...
                    <span style="color:darkred;display:none;"
                        ...
                        <br>
                        This master public key has already been used on another website. Please provide the same email address you you used to register it the first time, or create a new cryptocurrency wallet for this website. <a href="mailto:plugin.support@triple-a.io">Contact us at plugin.support@triple-a.io</a> if you need assistance.
                    </span>
                    <span style="color:darkred;display:none;"
                            class="triplea-error-msg pubkey-unexpected-error"
                            id="bitcoin-error-pubkey-unexpected-error">
                        <br>
                        An unexpected error occurred. <a href="mailto:plugin.support@triple-a.io">Contact us at plugin.support@triple-a.io</a> if you need assistance.
                        <br>
                ...
                <p>
                    ...
                    <span class="woocommerce-help-tip"
                            data-tip="Choose your preffered currency that you want for settlement."></span>
                    <br>
                    <select name="preferred-currency-expert" 
                            id="preferred-currency-expert" 
                            class="signup-input"
                            style="width:330px">
                        <option value="-" disabled=""> – select –</option>
                        <option value="usd" selected="">USD</option>
            ...
            <div class="triplea_step" id="receive-bitcoin-validate-email" style="opacity: 0.5;">
                ...
                <small style="color:darkred;display:none;"
                    ...
                    Something went wrong while requesting OTP code. Try again, or
                    contact us at plugin.support@triple-a.io so that we can assist you.
                </small>
                <p id="bitcoin-enter-otp" style="opacity: 0.5;">
                    ...
                    <input type="button"
                            ...
                            class="button-primary"
                            value="Activate cryptocurrency account"
                    ...
                    <small style="color:darkred;display:none;"
                        ...
                        The provided OTP was correct. However, something went wrong
                        during the creation of your testnet cryptocurrency account. Please inform us
                        at plugin.support@triple-a.io so that we may assist you promptly.
                    </small>
                </p>
            </div>
        </div>
   ...
   <script>
    ...
    function triplea_fiat_createMerchantAccount() {
        ...
        otpRequestNotifEmail = merchantEmail; // TODO need different Notification emails stored, for cryptocurrency or localcurrency !

        // Ask for OTP to be sent to email address.

        const url      = `https://api.triple-a.io/api/v1/merchant`;
    ...
    function triplea_fiat_validateEmailOtp() {
        ...
        const url      = `https://api.triple-a.io/api/v1/merchant/` + merchantAccountRequestResult.merchant_key + `/verify`;
    ...
    function triplea_testnetbitcoin_emailvalidationstep() {
        ...
        if (pubkey.indexOf('pub') !== 1 || (pubkey.indexOf('tpub') < 0 && pubkey.indexOf('upub') < 0 && pubkey.indexOf('vpub') < 0) )
        {
    ...
    function triplea_bitcoin_emailvalidationstep() {
        ...
        if (pubkey.indexOf('pub') !== 1 || (pubkey.indexOf('xpub') !== 0 && pubkey.indexOf('ypub') !== 0 && pubkey.indexOf('zpub') !== 0 && pubkey.indexOf('tpub') !== 0 && pubkey.indexOf('upub') !== 0 && pubkey.indexOf('vpub') !== 0)) {
            console.warn('TripleA Warning: Incorrect public key format. Cannot proceed.');
            jQuery('#bitcoin-wrong-pubkey-format').show();
            return;
        }
        ...
        if (pubkey.indexOf('tpub') === 0 || pubkey.indexOf('upub') === 0 || pubkey.indexOf('vpub') === 0) {
    ...
    function triplea_bitcoin_createMerchantAccount() {
        let merchantEmail, merchantPhone, merchantPreferedCurrency;
        ...
        merchantPreferedCurrency = document.getElementById('preferred-currency-expert').value.toUpperCase();
        ...
        const data          = {
            ...
            email         : merchantEmail,
            phone         : merchantPhone || undefined,
            local_currency: merchantPreferedCurrency,
            source        : 'woocommerce',
    ...
    function triplea_bitcoin_createMerchantAccountCallbackError(err) {
        ...
        if (jsonErr && jsonErr.message === 'pubkey_exists') {
            ...
            //if (jsonErr && jsonErr.message === 'validation_error')
    ...
    jQuery(document).ready(function(e){
        if( jQuery('.triplea-terms').prop('checked') == false ) {
            jQuery('.signup-btn').attr('disabled', true);
        } else {
            jQuery('.signup-btn').attr('disabled', false);
        }
        jQuery('.triplea-terms').on('change', function(){
    ...
    function triplea_localcurrency_emailvalidationstep() {
        ...
        if (!localcurrencyEmail || (localcurrencyEmail.indexOf('@') < 1 || localcurrencyEmail.lastIndexOf('.') < localcurrencyEmail.indexOf('@'))) {
            console.warn('TripleA Warning: Incorrect email. Cannot proceed.');
    ...
    function triplea_localcurrency_createMerchantAccount() {
        ...
        merchantPreferedCurrency = document.getElementById('preferred-currency').value.toUpperCase();
        ...
        const data          = {
            ...
            local_currency: merchantPreferedCurrency,                // TODO fiat: give choice of preferred local currency for settlement
            source        : 'woocommerce',
            master_pubkey : undefined,
            direct        : undefined,
            pid           : undefined,
    ...
    function triplea_testnetbitcoin_upgradeMerchantAccount() {
        ...
        const url      = `https://api.triple-a.io/api/v1/merchant/upgrade`;
    ...
    <!--section id="TripleA-debugging-information" data-info="Share this via plugin.support@triple-a.io if asked by TripleA support">
    <pre><?php

        echo print_r(get_option('                                                   '), TRUE);
